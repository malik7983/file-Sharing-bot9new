...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('😎 contact me 😎', url=f"https://t.me/sahid_malik")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/+ZeZNvt43B4o3ZmJl'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/m_house786')
            ],[      
